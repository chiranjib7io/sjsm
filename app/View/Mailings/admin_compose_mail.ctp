   ...
   <!-- Content Header (Page header) -->
        ...
        <section class="content">
          <div class="row">
			...
			<?php echo $this->Form->create('mailings',array('admin'=>true,'action'=>'compose_mail')); ?>
              ...
              <div class="box box-danger col-xs-12" style="padding-top:20px; padding-bottom:20px;">
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php $types = array('text'=>'Text','select'=>'Selectbox','email'=>'Email','number'=>'Number','file'=>'File','textarea'=>'Textarea'); ?>
                ...
                <div class="box-body col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php $groups = array('general'=>'General','phone'=>'Phone Number','address'=>'Address','experience'=>'Experience','emergency_contact'=>'Emergency Contact','notes'=>'Notes','attachment'=>'Attachment'); ?>
